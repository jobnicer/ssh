 ...
 * 
 * @author ZT
 * @date 2014-1-24 下午04:19:18
 */
public class DateUtil {

	/**
	 * yyyy-MM-dd : 2014-1-24
	 */
	public final static String FORMAT_DATE = "yyyy-MM-dd";
	/**
	 * yyyy-MM-dd HH:mm:ss : 2014-01-24 15:55:24
	 */
	...
	public static Date getCalcDatetimeByHours(Date tm, int nhours) {
		Calendar cal = Calendar.getInstance();
		cal.setTime(tm);
	...
	public static Date getCalcDatetime(Date tm, int nMinutes) {
		Calendar cal = Calendar.getInstance();
		cal.setTime(tm);
